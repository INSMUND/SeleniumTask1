...
public class ProductsToCartAddition extends TestBase {
	...
	public void productToCartAdditionTest() {
		...
		for (int i = 1; i <= initialCartSize; i++) {
			...
			wait.until(
					ExpectedConditions.numberOfElementsToBe(By.xpath("//tr//td[@class='item']"), initialCartSize - i));
		}
		System.out.println("All products are uccessfully deleted from Cart");
	}
	...
	private void addProductToCart(int i) {
		...
		wait.until(ExpectedConditions.textToBePresentInElementLocated(
				By.xpath("//div[@id='cart']//span[@class='quantity']"), Integer.toString(i)));
